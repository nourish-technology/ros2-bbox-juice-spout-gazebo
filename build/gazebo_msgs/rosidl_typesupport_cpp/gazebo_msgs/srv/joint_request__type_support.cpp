...
static const _JointRequest_Request_type_support_symbol_names_t _JointRequest_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, gazebo_msgs, srv, JointRequest_Request)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, gazebo_msgs, srv, JointRequest_Request)),
  }
};
...
static const _JointRequest_Response_type_support_symbol_names_t _JointRequest_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, gazebo_msgs, srv, JointRequest_Response)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, gazebo_msgs, srv, JointRequest_Response)),
  }
};
...
static const _JointRequest_type_support_symbol_names_t _JointRequest_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, gazebo_msgs, srv, JointRequest)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, gazebo_msgs, srv, JointRequest)),
  }
};
