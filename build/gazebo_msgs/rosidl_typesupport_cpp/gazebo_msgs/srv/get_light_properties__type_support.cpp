...
static const _GetLightProperties_Request_type_support_symbol_names_t _GetLightProperties_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, gazebo_msgs, srv, GetLightProperties_Request)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, gazebo_msgs, srv, GetLightProperties_Request)),
  }
};
...
static const _GetLightProperties_Response_type_support_symbol_names_t _GetLightProperties_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, gazebo_msgs, srv, GetLightProperties_Response)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, gazebo_msgs, srv, GetLightProperties_Response)),
  }
};
...
static const _GetLightProperties_type_support_symbol_names_t _GetLightProperties_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, gazebo_msgs, srv, GetLightProperties)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, gazebo_msgs, srv, GetLightProperties)),
  }
};
