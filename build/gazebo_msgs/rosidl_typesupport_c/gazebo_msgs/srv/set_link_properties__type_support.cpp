...
static const _SetLinkProperties_Request_type_support_symbol_names_t _SetLinkProperties_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, gazebo_msgs, srv, SetLinkProperties_Request)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, gazebo_msgs, srv, SetLinkProperties_Request)),
  }
};
...
static const _SetLinkProperties_Response_type_support_symbol_names_t _SetLinkProperties_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, gazebo_msgs, srv, SetLinkProperties_Response)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, gazebo_msgs, srv, SetLinkProperties_Response)),
  }
};
...
static const _SetLinkProperties_type_support_symbol_names_t _SetLinkProperties_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_c, gazebo_msgs, srv, SetLinkProperties)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, gazebo_msgs, srv, SetLinkProperties)),
  }
};
