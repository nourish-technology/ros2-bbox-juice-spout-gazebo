...
static const _GetModelList_Request_type_support_symbol_names_t _GetModelList_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, gazebo_msgs, srv, GetModelList_Request)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, gazebo_msgs, srv, GetModelList_Request)),
  }
};
...
static const _GetModelList_Response_type_support_symbol_names_t _GetModelList_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, gazebo_msgs, srv, GetModelList_Response)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, gazebo_msgs, srv, GetModelList_Response)),
  }
};
...
static const _GetModelList_type_support_symbol_names_t _GetModelList_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_c, gazebo_msgs, srv, GetModelList)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, gazebo_msgs, srv, GetModelList)),
  }
};
