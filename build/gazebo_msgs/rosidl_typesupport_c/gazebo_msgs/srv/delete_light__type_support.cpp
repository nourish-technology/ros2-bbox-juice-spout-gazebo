...
static const _DeleteLight_Request_type_support_symbol_names_t _DeleteLight_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, gazebo_msgs, srv, DeleteLight_Request)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, gazebo_msgs, srv, DeleteLight_Request)),
  }
};
...
static const _DeleteLight_Response_type_support_symbol_names_t _DeleteLight_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, gazebo_msgs, srv, DeleteLight_Response)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, gazebo_msgs, srv, DeleteLight_Response)),
  }
};
...
static const _DeleteLight_type_support_symbol_names_t _DeleteLight_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_c, gazebo_msgs, srv, DeleteLight)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, gazebo_msgs, srv, DeleteLight)),
  }
};
