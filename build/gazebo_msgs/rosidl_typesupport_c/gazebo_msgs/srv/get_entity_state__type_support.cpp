...
static const _GetEntityState_Request_type_support_symbol_names_t _GetEntityState_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, gazebo_msgs, srv, GetEntityState_Request)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, gazebo_msgs, srv, GetEntityState_Request)),
  }
};
...
static const _GetEntityState_Response_type_support_symbol_names_t _GetEntityState_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, gazebo_msgs, srv, GetEntityState_Response)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, gazebo_msgs, srv, GetEntityState_Response)),
  }
};
...
static const _GetEntityState_type_support_symbol_names_t _GetEntityState_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_c, gazebo_msgs, srv, GetEntityState)),
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, gazebo_msgs, srv, GetEntityState)),
  }
};
