...
#include "nourish_robot_arm_msgs/msg/speed__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const nourish_robot_arm_msgs::msg::Speed *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nourish_robot_arm_msgs::msg::Speed *>(
    untyped_ros_message);
...
{
  return &nourish_robot_arm_msgs::msg::typesupport_fastrtps_cpp::_Speed__handle;
}
