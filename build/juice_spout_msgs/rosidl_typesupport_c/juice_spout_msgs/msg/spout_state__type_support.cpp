...
static const _SpoutState_type_support_symbol_names_t _SpoutState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, juice_spout_msgs, msg, SpoutState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, juice_spout_msgs, msg, SpoutState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, juice_spout_msgs, msg, SpoutState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, juice_spout_msgs, msg, SpoutState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, juice_spout_msgs, msg, SpoutState)() {
  return &::juice_spout_msgs::msg::rosidl_typesupport_c::SpoutState_message_type_support_handle;
}
