...
class Metaclass_Response(type):
    ...
    def STATUS_SUCCESS(self):
        ...
        return Metaclass_Response.__constants['STATUS_SUCCESS']

    @property
    def STATUS_ERROR_NOT_CONNECTED(self):
        """Message constant 'STATUS_ERROR_NOT_CONNECTED'."""
        return Metaclass_Response.__constants['STATUS_ERROR_NOT_CONNECTED']

    @property
    def STATUS_ERROR_UNKNOWN(self):
        """Message constant 'STATUS_ERROR_UNKNOWN'."""
        return Metaclass_Response.__constants['STATUS_ERROR_UNKNOWN']
