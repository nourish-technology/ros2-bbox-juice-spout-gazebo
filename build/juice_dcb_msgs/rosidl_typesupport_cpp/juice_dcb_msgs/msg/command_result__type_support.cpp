...
static const _CommandResult_type_support_symbol_names_t _CommandResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, juice_dcb_msgs, msg, CommandResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, juice_dcb_msgs, msg, CommandResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, juice_dcb_msgs, msg, CommandResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_cpp, juice_dcb_msgs, msg, CommandResult)),
  }
};
...
{
  return &::juice_dcb_msgs::msg::rosidl_typesupport_cpp::CommandResult_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, juice_dcb_msgs, msg, CommandResult)() {
  return get_message_type_support_handle<juice_dcb_msgs::msg::CommandResult>();
}
