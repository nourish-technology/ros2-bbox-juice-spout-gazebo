...
set(_exported_libraries "gazebo_ros_node;gazebo_ros_utils;gazebo_ros_init;gazebo_ros_factory;gazebo_ros_properties;gazebo_ros_state")
...
if(NOT _exported_library_names STREQUAL "")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING "Package 'gazebo_ros' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND gazebo_ros_LIBRARIES ${_cfg} "${_lib}")
