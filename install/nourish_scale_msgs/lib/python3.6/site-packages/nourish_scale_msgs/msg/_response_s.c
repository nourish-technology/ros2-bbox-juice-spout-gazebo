...
bool nourish_scale_msgs__msg__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "nourish_scale_msgs.msg._response.Response",
        full_classname_dest, 41) == 0);
  }
  nourish_scale_msgs__msg__Response * ros_message = _ros_message;
  {  // status
...
PyObject * nourish_scale_msgs__msg__response__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("nourish_scale_msgs.msg._response");
