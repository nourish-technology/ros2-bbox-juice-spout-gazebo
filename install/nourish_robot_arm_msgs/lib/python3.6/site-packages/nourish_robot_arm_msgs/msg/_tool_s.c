...
bool nourish_robot_arm_msgs__msg__tool__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "nourish_robot_arm_msgs.msg._tool.Tool",
        full_classname_dest, 37) == 0);
  }
  nourish_robot_arm_msgs__msg__Tool * ros_message = _ros_message;
  {  // robhold
...
PyObject * nourish_robot_arm_msgs__msg__tool__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("nourish_robot_arm_msgs.msg._tool");
