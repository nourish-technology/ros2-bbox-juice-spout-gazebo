...
#ifndef NOURISH_ROBOT_ARM_MSGS__MSG__ACCELERATION__TYPE_SUPPORT_H_
#define NOURISH_ROBOT_ARM_MSGS__MSG__ACCELERATION__TYPE_SUPPORT_H_
...
#endif  // NOURISH_ROBOT_ARM_MSGS__MSG__ACCELERATION__TYPE_SUPPORT_H_
