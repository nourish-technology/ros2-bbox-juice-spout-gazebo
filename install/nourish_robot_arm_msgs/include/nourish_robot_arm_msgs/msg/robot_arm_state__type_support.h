...
#ifndef NOURISH_ROBOT_ARM_MSGS__MSG__ROBOT_ARM_STATE__TYPE_SUPPORT_H_
#define NOURISH_ROBOT_ARM_MSGS__MSG__ROBOT_ARM_STATE__TYPE_SUPPORT_H_
...
#endif  // NOURISH_ROBOT_ARM_MSGS__MSG__ROBOT_ARM_STATE__TYPE_SUPPORT_H_
